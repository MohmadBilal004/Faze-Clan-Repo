 ...
 */
public class AddSparePartsUI1 extends javax.swing.JFrame {
    ...
    public void updateDB() {
        try {
            ...
            pst = conn.prepareStatement("SELECT * FROM SpareParts");
...
//            dtm = (DefaultTableModel) jTable1.getModel();
            ...
            while (rs.next()) {
                ...
                for (int i = 1; i <= stData.getColumnCount(); i++) {

                    colData.add(rs.getInt("SparePartID"));
                    colData.add(rs.getString("NameofItem"));
                    colData.add(rs.getString("Category"));
                    colData.add(rs.getString("Brand"));
    ...
    public void tableLoad() {
        try {
            String sql = "SELECT * FROM SparePartsDB.SpareParts";
//            pst = conn.prepareStatement(sql);
//            rs = (ResultSet) pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel((ResultSet) conn.prepareStatement(sql).executeQuery()));
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 530, 460));
        ...
        getContentPane().add(kButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 490, 140, -1));
        ...
        getContentPane().add(kButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 490, 120, -1));
        ...
        getContentPane().add(kButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 490, 120, -1));
...
//                jTextField4.setText(dtm.getValueAt(row, 3).toString());
                for (int j = 0; j < (spCategoryBox.getItemCount()); j++) {
...
//            Class.forName("com.mysql.jdbc.Driver");
//            conn = DriverManager.getConnection(URL, user, password);
            String qry = "INSERT INTO SparePartsDB.SpareParts VALUES('"+sparePartID+"','"+nameOfItem+"','"+category+"','"+brand+"','"+quantity+"')";
            pst = conn.prepareStatement(qry);
            
            spControll = new SpareParts(sparePartID, nameOfItem, category, brand, quantity);

//            pst.setInt(1, sparePartID);
//            pst.setString(2, nameOfItem);
//            pst.setString(3, category);
//            pst.setString(4, brand);
//            pst.setInt(5, quantity);

            pst.execute();
            JOptionPane.showMessageDialog(this, "Successfully Added : "+String.valueOf(sparePartID)+"", "Success", 1);
            updateDB();
...
//        }
//
//        spArr.add(new SpareParts(sparePartID, nameOfItem, category, brand, quantity));
//        dtm.setRowCount(0); // reset data model 
//        for (int i = 0; i < spArr.size(); i++) {
//            Object[] objs = {spArr.get(i).getSparePartID(), spArr.get(i).getNameOfItem(), spArr.get(i).getCategory(), spArr.get(i).getBrand(), spArr.get(i).getQuantity()};
//            dtm.addRow(objs);
        }
        clearField();
    ...
    private void kButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton4ActionPerformed
        ...
        if (dialogResult == 0) {
            ...
            try {
                ...
                String delete = "DELETE FROM SparePartsDB.SpareParts WHERE SparePartID=" + spArr.get(row).getSparePartID() + ";"; //spArr.get(row).getSparePartID()
    ...
    private void kButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton5ActionPerformed
        ...
        spArr.get(row).setNameOfItem(updatenameOfItem);
        spArr.get(row).setSparePartID(updatesparePartID);
        spArr.get(row).setCategory(updatescategory);
        spArr.get(row).setBrand(updatesbrand);
        spArr.get(row).setQuantity(updatequantity);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSparePartsUI1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        AddSparePartsUI1 adsp = new AddSparePartsUI1();

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                adsp.showData();
                new AddSparePartsUI1().setVisible(true);
            }
        });
    }
