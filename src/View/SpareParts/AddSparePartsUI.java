 ...
 */
public class AddSparePartsUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 30, 510, 470));
...
//                jTextField4.setText(dtm.getValueAt(row, 3).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSparePartsUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        AddSparePartsUI adsp = new AddSparePartsUI();
